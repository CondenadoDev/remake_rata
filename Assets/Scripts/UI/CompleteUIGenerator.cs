...
public class CompleteUIGenerator : MonoBehaviour
{
    ...
    void RegisterAllPanels()
    {
        ...
        LogDebug($"✅ Registered {allPanels.Count} panels with UIManager");
    }
...
public class ConcreteUIPanel : UIPanel
{
    ...
    {
        // Asignar campos protegidos antes de la inicialización base
        ...
        SetNavigation(nextPanelIDSetting, previousPanelIDSetting);
